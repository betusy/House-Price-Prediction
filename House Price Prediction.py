...
# Elimizdeki veri seti uzerinden min hata ile ev fiyatlarini tahmin eden bir makine ogrenmesi modeli gelistirecegiz

# Kaggle yarismasi icin
...
# Train ve Test veri setlerini okutup birlestirelim.
...
# Numeric ve kategorik degiskenlerin yakalanmasi
...
# Target'in logaritmasinin incelenmesi (Hesaplama tarafinda bize avantaj sagliyor)
...
# Heatmap'de korelasyona bakalim
...
# Bazi degiskenlerin missing olması evin o ozelliginin olmamasi olabilir
no_cols = ["Alley","BsmtQual","BsmtCond","BsmtExposure","BsmtFinType1","BsmtFinType2","FireplaceQu",
           "GarageType","GarageFinish","GarageQual","GarageCond","PoolQC","Fence","MiscFeature"]

# Kolonlardaki missingleri "No" ifadesi ile dolduralim
for col in no_cols:
    df[col].fillna("No", inplace=True)

missing_values_table(df)

# Missing valuelari mean ve median ile dolduralim
...
# Kategorik degiskenlerin dagiliminin incelenmesi
...
# Train verisi ile model kurup, model basarisini degerlendirelim.
...
# BONUS : Log donusumu yaparak model kuralim ve rmse sonuclarini gozlemleyelim.
# Not: Log'un tersini (inverse) almayi unutma.
...
y_pred
# LOG donusumunun tersinin (inverse) alinmasi
...
# Hiperparametre optimizasyonlari
...
# test dataframeindeki bos olan salePrice degiskenlerin tahmini
